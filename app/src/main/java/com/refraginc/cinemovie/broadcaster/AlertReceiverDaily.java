...
public class AlertReceiverDaily extends BroadcastReceiver {
    private static String CHANNEL_ID = "CHANNEL_2";
    private static String CHANNEL_NAME = "Cinemovie Daily Channel";

    @Override
    public void onReceive(Context context, Intent intent) {

        notif( context, "Hey, we have lots of Movies and Tv Shows", "Mark them to watch its later..." );

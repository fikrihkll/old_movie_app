...
public class MovieProvider extends ContentProvider {
    ...
    static final String PROVIDER_NAME = "com.refraginc.cinemovie.contentprovider.MovieProvider";
    static final String URL = "content://" + PROVIDER_NAME + "/data";
    public static final Uri CONTENT_URI = Uri.parse( URL );
    static final int MOVIE = 1;
    static final int MOVIE_ID = 2;
    static final UriMatcher uriMatcher;
    static final String DATABASE_NAME = "CMovieDB";
    ...
    static {
        ...
        uriMatcher.addURI( PROVIDER_NAME, "data", MOVIE );
        uriMatcher.addURI( PROVIDER_NAME, "data/#", MOVIE_ID );
    }
